...
* Make symlink for ./jobsmanager_transit/jobsmanager_transit in plugins directory
* Run complex rest server

## Running the tests
Run all tests:
```bash
python ./complex_rest/manage.py test ./plugin_dev/jobsmanager_transit/tests --settings=core.settings.test
```
